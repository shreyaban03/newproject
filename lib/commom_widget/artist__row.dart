...
class  ArtistRow extends StatelessWidget {
  ...
  const ArtistRow({super.key, required this.aObj,required this.onPressed, required this.onPressedMenuSelect});
            ...
            const SizedBox(
                                   ...
                                   SizedBox(
                                    ...
                                    child: PopupMenuButton<int>(
                                       ...
                                       elevation:1,
                                    icon: Image.asset("assets/images/more.png",width:20,height: 20,color: Colors.white,),
                                    padding: EdgeInsets.zero,
                                      ...
                                      const  PopupMenuItem(
                                        ...
                                        const  PopupMenuItem(
                                          value:3,
                                          height: 30,
                                          child:  Text("Add to playing queue",style:TextStyle(fontSize: 12),),
                                        ),
                                        const  PopupMenuItem(
                                          value:4,
                                          height: 30,
                                        ...
                                        const  PopupMenuItem(
                                          value:9,
                                          height: 30,
                                          child:  Text("Delete from device",style:TextStyle(fontSize: 12),),
                                        ),
                                        ];
                                      }
                                      ),)
