    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          title: Text("Artist Details",style: TextStyle(
                  ...
                  children: [
                    ClipRect(
                      child: ImageFiltered(
                        ...
                        child: Image.asset("assets/images/c9cde740-c020-4588-b66d-970094e2181a.jpeg",
                    ...
                    Padding(
                            ...
                            children: [
                              ...
                              Expanded(child: Column(
                                ...
                                children: [
                                  ...
                                  Text("R&B . Pop . Funk ",style: TextStyle(
                      ...
                      Row(
                        ...
                        children: [
                            ...
                            Text("38,700,000 Followers",style: TextStyle(
                                color: TColor.primaryText.withOpacity(0.74),
                                fontSize: 18,
                                fontWeight: FontWeight.w600),),

                                 const SizedBox(width: 20,),
                            Text("5,50,49,085 listeners",style: TextStyle(
                                color: TColor.primaryText.withOpacity(0.74),
                                fontSize: 18,
                                fontWeight: FontWeight.w600),),
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Image.asset("assets/images/icons8-add-50.png",
                                    width: 18,height: 18,
                                    fit:BoxFit.contain ,),
                                    const SizedBox(
                                      width: 8,
