...
import 'package:flutter_application_1/commom_widget/artist__row.dart';
import 'package:flutter_application_1/view/songs/artist_details_view.dart';
    ...
    return Scaffold(
      body: Obx(() => ListView.builder(
        ...
        itemBuilder: (context,index){
          ...
          return  ArtistRow(aObj:aObj,onPressed:(){
